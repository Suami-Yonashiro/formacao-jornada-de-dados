...
def processar_temperaturas(path_do_txt: Path):
    """Processar um arquivo de temperaturas acumulando estatísticas por
    estação.
    Essa função lê um arquivo de texto contendo registros de estações
    meteorológicas e suas respectivas temperaturas. Ela utilizar uma abordagem
    de streaming para calcular os valores mínimo, máximo e média de cada
    estação em tempo real, garantindo baixo consumo de memória RAM.
    Args:
    ...
    Returns:
        ...
        nomes das estações e os valores strings formatadas como 'mínimo/média/
        máximo'.
        Exemplo: {'Lisboa': '12.4/22.1/34.0'}
    Raises:
        FileNotFoundError: Se o arquivo no caminho especificado não for
        encontrado."""
    print("Iniciando o processamento do arquivo.")
    start_time = time.time()  # Tempo de início
    # ALTERAÇÃO 1: O dicionário guarda um dicionário interno com o
    # "estado" da cidade
    # Em vez de uma lista gigante de números, guardamos apenas o resumo.
    estatisticas_por_station = defaultdict(
