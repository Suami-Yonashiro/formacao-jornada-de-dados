...
pasta_sucessos = (
    []
)  # temos o log como dicionário acima, porém essa analise muitas vezes vem de uma lista e criamos as pastas para separar as ocorrências.
for log in logs:
    if log["level"] == "ERROR":
...
nome, idade_texto, email = input(
    "Digite nome, idade e e-mail (separados por espaço): "
).split()
