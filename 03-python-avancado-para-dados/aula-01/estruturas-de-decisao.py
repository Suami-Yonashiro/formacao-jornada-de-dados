...
if saldo >= 3:
    ...
    print("Tá uma desgraça! O time está perdendo feio")
...
teve_gol = True
revisao_do_var = "mao"  # legal, impedido, mao e falta
...
elif pontos == 6 and jogo_direto_contra_lider and saldo >= 3:
...
if nome_jogador == "Cristiano Ronaldo":
    print("O jogador é o Cristiano Ronaldo")
...
# =========================================================
# 9) O mesmo exemplo com IF / ELIF / ELSE
# =========================================================
